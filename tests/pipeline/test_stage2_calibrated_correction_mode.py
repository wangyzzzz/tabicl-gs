...
def test_append_stage2_prior_feature_supports_calibrated_correction():
    spec = TwoStageModelSpec(
        name="TabICLv2-CalibratedCorrection",
        stage1_backend="tabicl",
        stage2_backend="calibrated_correction",
        stage1_config={},
        stage2_config={
...
def test_resolve_stage2_prior_supports_calibrated_correction():
    spec = TwoStageModelSpec(
        name="TabICLv2-CalibratedCorrection",
        stage1_backend="tabicl",
        stage2_backend="calibrated_correction",
