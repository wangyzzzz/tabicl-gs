...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fold1 strict-OOF dual-prior block search.")
    parser.add_argument("--config", default="configs/tabicl_block/window_tabicl_calibrated_correction_dualprior_y.yaml")
